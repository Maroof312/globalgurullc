...
const faqs = [
  {
    ...
    answer:
      "Yes. Our team has extensive hands-on experience implementing Yardi for real estate companies. We configure modules, set up workflows, and design reporting dashboards that optimize daily operations."
  },
  {
    question: "Can you train my staff on Yardi property accounting?",
    answer:
      "Absolutely. We provide customized Yardi training for property managers, accountants, and finance staff. Our goal is to help your team use Yardi to its full potential."
  },
  {
    question: "What makes your Yardi expertise stand out?",
    answer:
      "Our Yardi experts go beyond system setup. We help clients unlock advanced features, build customized reports, and optimize usage to improve productivity, compliance, and financial decision-making."
  }
];
  ...
  return (
    <div className="yardi-page">
      ...
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://globalgurullc.com/yardi-consultation-services"
        />
        <meta
          name="description"
      ...
      <section className="yardi-hero">
        <div className="hero-image-wrapper">
          {/* ✅ Background image removed; replaced with creative CSS background */}
            ...
            <Container>
              ...
              >
                ...
                <h1 className="hero-title">
                  End-to-End Yardi Consultation Services for Real Estate Success
                </h1>
            ...
            <Col lg={10} className="text-center">
              ...
              >
                ...
                <p className="section-subtitle">
                  Most firms offer generic tech help, but Global Guru is different. Our expert Yardi consultants understand
                  real estate challenges and know how to solve them using Yardi&apos;s full capabilities.
                </p>
              </motion.div>
            </Col>
          </Row>
          ...
          <Row className="justify-content-center mb-5">
            <Col lg={10} className="text-center">
              ...
              >
                ...
                <p className="section-subtitle">
                  Our Yardi consulting supports clients across a wide range of real estate verticals. Whether you operate a small local portfolio or a nationwide property group, we have the experience to support your goals.
                </p>
              </motion.div>
            </Col>
          </Row>
          ...
          <Row className="justify-content-center mb-5">
            <Col lg={10} className="text-center">
              ...
              >
                ...
                <p className="section-subtitle">
                  When you choose Global Guru, you gain more than a technical consultant. You gain a business partner focused on tangible improvements.
                </p>
              </motion.div>
            </Col>
          </Row>
